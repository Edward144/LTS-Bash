...
#Database Details
sourceDatabase="ltssource"
sourceUsername="admin"
sourcePassword="Mandescest19"
sourceHost="localhost" #Use localhost not 127.0.0.1
sourcePort="3310"

destinationDatabase="ltsdest"
destinationUsername="admin"
destinationPassword="Mandescest19"
...
customSQL="INSERT INTO \`test\` (value) VALUES(123);INSERT INTO \`test\` (value) VALUES(999);"
